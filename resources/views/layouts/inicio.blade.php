    ...
    <nav class="navbar navbar-expand-md fixed-top flex-md-nowrap p-0 shadow">
      ...
      <ul class="navbar-nav ml-auto pull-right">
        <li class="nav-item text-nowrap">
              <a style="color:#FFFB72;"  class="nav-link" href="#">Quiénes Somos?</a>
          </li>
          <li class="nav-item text-nowrap">
              <a style="color:#FFFB72;"  class="nav-link" href="#">Servicios</a>
          </li>
           <li class="nav-item text-nowrap">
              <a style="color:#FFFB72;"  class="nav-link" href="#">Media  </a>
          </li>
      </ul>
      @section('menufijo')
