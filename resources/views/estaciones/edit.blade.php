...
<div class="card">
    ...
    <div class="card-body">
        ...
        @endif
        <form method="POST" action="{{ url("/estaciones/{$estacion->id}")}}" enctype="multipart/form-data">
        {{ method_field('PUT') }}
        ...
        <div class="container col-md-12 col-md-offset-0" id="form1" name="form1">
            ...
            <div class="row">
                <div class="col-sm-2">
                    ...
                    <input type="text" class="form-control" name="codigo" id="codigo" placeholder="Código" value="{{ old('codigo',$estacion->codigo) }}" required="true">
                </div>
                <div class="col-sm-4">
                    <label for="nombre">Nombre de la Estación de Servicio:</label>
                    <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre de la Estación de Servicio" value="{{ old('nombre',$estacion->nombre) }}" required="true">
                </div>
                <div class="col-sm-6">
                    <label for="descripcion">Descripción:</label>
                    <input type="text" class="form-control" name="descripcion" id="descripcion" placeholder="Descripción de la Estación de Servicio" value="{{ old('descripcion',$estacion->descripcion) }}" required="true">
                </div>
            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" name="nombre_responsable" id="nombre_responsable" placeholder="Nombre y Apellido"value="{{ old('nombre_responsable',$estacion->nombre_responsable) }}" required="true">
                </div>
                <div class="col-sm-3">
                    <label for="email_responsable">Email del Responsable:</label>
                    <input type="email" class="form-control" name="email_responsable" id="email_responsable" placeholder="nombre@dominio.com" value="{{ old('email_responsable',$estacion->email_responsable) }}" required="true">
                </div>
                <div class="col-sm-3">
                    <label for="rfc_estacion">Nro. RFC de la Estación:</label>
                    <input type="text" class="form-control" name="rfc_estacion" id="rfc_estacion" placeholder="Nro. RFC de la Estación" value="{{ old('rfc_estacion',$estacion->rfc_estacion) }}" required="true">
                </div>
                <div class="col-sm-3">
                    <label for="nro_estacion">Nro. Estación PEMEX:</label>
                    <input type="text" class="form-control" name="nro_estacion" id="nro_estacion" placeholder="Nro. Estación PEMEX" value="{{ old('nro_estacion',$estacion->nro_estacion) }}">
                </div>
            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" name="nroper_cre" id="nroper_cre" placeholder="Nro. Permiso ante la CRE" value="{{ old('nroper_cre',$estacion->nroper_cre) }}" required="true">
                </div>
                <div class="col-sm-4">
                    <label for="logo">Logo:</label>
                    <input type="file" class="form-control-file" name="logo" id="logo" value="{{ old('logo',$estacion->logo) }}">
                </div>
                <div class="col-sm-4">
                    <label for="foto">Foto del Representante Legal:</label>
                    <input type="file" class="form-control-file" name="foto" id="foto"  value="{{ old('foto',$estacion->foto) }}">
                </div>
            </div>            
            <div class="row">
                <div class="col-sm-5">
        ...
        <div class="container col-md-12 col-md-offset-0" id="form4" name="form4" style="display:none;">        
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    ...
                    <input type="text" class="form-control" name="numero_despachadores" id="numero_despachadores" placeholder="Cantidad" value="{{ old('numero_despachadores',$estacion->numero_despachadores) }}">
                </div>
            ...
            <div class="row">
                <div class="col-sm-2">
                    ...
                    <input type="text" class="form-control" name="numero_empleados" id="numero_empleados" placeholder="Cantidad" value="{{ old('numero_empleados',$estacion->numero_empleados) }}">
                </div>            
                <div class="col-sm-4">
                ...
                <div class="col-sm-2">
                    ...
                    <input type="text" class="form-control" name="estatus_estacion" id="estatus_estacion" placeholder="Estatus" value="{{ old('estatus_estacion',$estacion->estatus_estacion) }}">
                </div>
                <div class="col-sm-4">
        ...
        <div class="container col-md-12 col-md-offset-0" id="form5" name="form5" style="display:none;">
            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" name="superficie_total_predio" id="superficie_total_predio" placeholder="En metros cuadrados" value="{{ old('superficie_total_predio',$estacion->superficie_total_predio) }}">
                </div>
                <div class="col-sm-3">
                    <label for="superficie_construccion">Superficie de Construcción:</label>
                    <input type="text" class="form-control" name="superficie_construccion" id="superficie_construccion" placeholder="En metros cuadrados" value="{{ old('superficie_construccion',$estacion->superficie_construccion) }}">
                </div>
                <div class="col-sm-2">
                    <label for="numero_pisos">Pisos:</label>
                    <input type="text" class="form-control" name="numero_pisos" id="numero_pisos" placeholder="Número de Pisos" value="{{ old('numero_pisos',$estacion->numero_pisos) }}">
                </div>
                <div class="col-sm-2">
                    <label for="escaleras">Escaleras:</label>
                    <input type="text" class="form-control" name="escaleras" id="escaleras" placeholder="Cantidad" value="{{ old('escaleras',$estacion->escaleras) }}">
                </div>
                <div class="col-sm-2">
                    <label for="bodega">Bodegas:</label>
                    <input type="text" class="form-control" name="bodega" id="bodega" placeholder="Cantidad" value="{{ old('bodega',$estacion->bodega) }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-2">
                    ...
                    <input type="text" class="form-control" name="hidroneumaticos" id="hidroneumaticos" placeholder="Cantidad" value="{{ old('hidroneumaticos',$estacion->hidroneumaticos) }}">
                </div>
                ...
                <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" name="planta_electrica" id="planta_electrica" placeholder="En Vatios" value="{{ old('planta_electrica',$estacion->planta_electrica) }}">
                </div>
            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" name="compresor" id="compresor" placeholder="En Caballos de Fuerza" value="{{ old('compresor',$estacion->compresor) }}">
                </div>
                <div class="col-sm-2">
                    <label for="numero_banos">Baños:</label>
                    <input type="text" class="form-control" name="numero_banos" id="numero_banos" placeholder="Cantidad" value="{{ old('numero_banos',$estacion->numero_banos) }}">
                </div>
                <div class="col-sm-3">
                    <label for="puestos_estacionamiento">Puestos de Estacionamiento:</label>
                    <input type="text" class="form-control" name="puestos_estacionamiento" id="puestos_estacionamiento" placeholder="Cantidad" value="{{ old('puestos_estacionamiento',$estacion->puestos_estacionamiento) }}">
                </div>
                <div class="col-sm-4">
                    <label for="puestos_estacionamiento_disc">Estacionamiento (Discapacitados):</label>
                    <input type="text" class="form-control" name="puestos_estacionamiento_disc" id="puestos_estacionamiento_disc" placeholder="Cantidad" value="{{ old('puestos_estacionamiento_disc',$estacion->puestos_estacionamiento_disc) }}">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    ...
                    <input type="text" class="form-control" name="surtidor_aire" id="surtidor_aire" placeholder="Cantidad" value="{{ old('surtidor_aire',$estacion->surtidor_aire) }}">
                </div>
                <div class="col-sm-2">
                    <label for="surtidor_agua">Surtidor de Agua:</label>
                    <input type="text" class="form-control" name="surtidor_agua" id="surtidor_agua" placeholder="Cantidad" value="{{ old('surtidor_agua',$estacion->surtidor_agua) }}">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-7">
