                      ...
                      <div class="panel-body">  
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <textarea class="form-control" rows="15" id="texto_modificado"  name="texto_modificado" placeholder="j. Indique el nuevo texto del documento modificado.">{{ old('texto_modificado') }}</textarea>
