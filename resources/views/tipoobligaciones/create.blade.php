...
<div class="card">
    ...
    <div class="card-body">
        ...
        @endif
        <form method="POST" action="{{ url('/tipoobligaciones')}}">
        {!! csrf_field() !!} <!-- para evitar ataques maliciosos en el metodo POST-->
            ...
            <a href="{{route('tipoobligaciones.index')}}" class="btn btn-link">Regresar al listado de Tipos de Obligacion Creados</a>
        </form>
    </div>
</div>
@endsection