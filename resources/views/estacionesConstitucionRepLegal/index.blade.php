        ...
        ?>
          ...
          <td>
            <form action="" method="POST">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
                <a href="{{route('estacionesConstitucionRepLegal.edit',$estacion)}}" class="btn btn-primary ">Actualizar Constitución y Rep. Legal</a>
                <a href="{{route('estacionesConstitucionRepLegal.show',$estacion)}}" class="btn btn-warning"><span class="glyphicon glyphicon-eye-open"></span></a>
            </form>
          </td>
        </tr>
        @endforeach
