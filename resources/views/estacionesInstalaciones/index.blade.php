        ...
        ?>
          ...
          <td>
            <form action="" method="POST">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
                <a href="{{route('estacionesInstalaciones.edit',$estacion)}}" class="btn btn-primary ">Actualizar Instalaciones</a>
                <a href="{{route('estacionesInstalaciones.show',$estacion)}}" class="btn btn-warning"><span class="glyphicon glyphicon-eye-open"></span></a>
            </form>
          </td>
        </tr>
        @endforeach
